...
class DeviceInventory(models.Model):
    ...
    cart_name = models.CharField('車次/散裝名稱', max_length=20)
...
class Booking(models.Model):
    ...
    periods_json = models.TextField('每週借用節次(JSON)', blank=True)
    ...
    status = models.CharField('狀態', max_length=20, default='借用中')
